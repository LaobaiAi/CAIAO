...
function LayoutContent({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden relative bg-background">
      {/* Brand — top-left */}
      <div className="absolute top-0 left-0 z-40 px-4 py-2 pointer-events-none">
        <span className="text-xl font-extrabold select-none bg-gradient-to-r from-cyan-400 via-blue-400 to-violet-400 bg-clip-text text-transparent drop-shadow-[0_0_8px_rgba(34,211,238,0.3)]">
          XuanwuAI
        </span>
      </div>

      {/* Brand — bottom-left */}
      <div className="absolute bottom-0 left-0 z-40 px-4 py-2 pointer-events-none">
        <span className="text-lg font-semibold select-none bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent opacity-80">
          CAIAO Visual
        </span>
      </div>
